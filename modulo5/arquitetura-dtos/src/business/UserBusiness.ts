...
export class UserBusiness {
  ...
  public getUsers = async (input: IGetUsersInputDTO) => {
    ...
    const response: IGetUsersOutputResponseDTO = {
      users,
    };   
  ...
  public deleteUser = async (input: IDeleteInputDTO) => {
    const token = input.token;
  ...
  public editUser = async (input: IEditUserDTO) => {
